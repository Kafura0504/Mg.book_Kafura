...
class TechnicalTest {
  ...
  List list = [
    ...
    () {
      ...
      // >>> Tulis jawabanmu di bawah ini
      String output = "Dart is fun!"; //no its not really
      // --- End of Answer ---
    ...
    () {
      ...
      // >>> Tulis jawabanmu di bawah ini
      var input = DateTime(2023, 08, 09);
      String? output = DateFormat('yyyy-MM-dd').format(input).toString();
      // --- End of Answer ---
